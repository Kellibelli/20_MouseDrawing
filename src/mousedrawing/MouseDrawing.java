...
{
    /**
     * Shows a class where we make our JFrame
     * <p>
     * Where we set up the JFrame and use new method of 2D Graphics
     * <p>
     * @author Kelli Garner
     * @version 1.0
     * @since 1.0
    ...
    {
        // frame constructor
        setTitle("Want to Draw Something? by Kelli Garner! March 2018");
        setResizable(false);
